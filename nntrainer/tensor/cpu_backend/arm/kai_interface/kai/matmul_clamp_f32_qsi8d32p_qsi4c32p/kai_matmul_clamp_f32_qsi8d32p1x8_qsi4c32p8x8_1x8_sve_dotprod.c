/**
 * @file kai_matmul_clamp_f32_qsi8d32p1x8_qsi4c32p8x8_1x8_sve_dotprod.c
 * @date   5 December 2025
 * @see    https://github.com/ARM-software/kleidiai
 * @author Sungsik Kong <ss.kong@samsung.com>
 * @bug    No known bugs except for NYI items
 * @brief  kai_matmul_clamp_f32_qsi8d32p1x8_qsi4c32p8x8_1x8_sve_dotprod.c
...
void kai_kernel_matmul_clamp_f32_qsi8d32p1x8_qsi4c32p8x8_1x8_sve_dotprod(
  KernelArgs *args_ptr);
...
inline static size_t kai_get_num_bytes_per_block_rhs(size_t bl) {
  ...
  size_t num_bytes_per_block_rhs =
    (bl / kai_num_bytes_recip_qvalue_rhs) + kai_num_bytes_multiplier_rhs;
...
inline static size_t kai_get_lhs_packed_stride(size_t k, size_t bl) {
  return kai_mr * kai_get_num_blocks_per_row(k, bl) *
...
inline static size_t kai_get_rhs_packed_stride(size_t k, size_t bl) {
  ...
  const size_t rhs_packed_stride =
    kai_nr * (num_bytes_per_block * num_blocks_per_row);

  return rhs_packed_stride;
}

size_t
kai_get_m_step_matmul_clamp_f32_qsi8d32p1x8_qsi4c32p8x8_1x8_sve_dotprod(void) {
  return kai_m_step;
}

size_t
kai_get_n_step_matmul_clamp_f32_qsi8d32p1x8_qsi4c32p8x8_1x8_sve_dotprod(void) {
  return kai_n_step;
}

size_t
kai_get_mr_matmul_clamp_f32_qsi8d32p1x8_qsi4c32p8x8_1x8_sve_dotprod(void) {
  return kai_mr;
}

size_t
kai_get_nr_matmul_clamp_f32_qsi8d32p1x8_qsi4c32p8x8_1x8_sve_dotprod(void) {
  return kai_nr;
}

size_t
kai_get_kr_matmul_clamp_f32_qsi8d32p1x8_qsi4c32p8x8_1x8_sve_dotprod(void) {
  return kai_kr;
}

size_t
kai_get_sr_matmul_clamp_f32_qsi8d32p1x8_qsi4c32p8x8_1x8_sve_dotprod(void) {
  return kai_sr;
}
...
void kai_run_matmul_clamp_f32_qsi8d32p1x8_qsi4c32p8x8_1x8_sve_dotprod(
  ...
  KAI_ASSERT_MSG(
    kai_get_sve_vector_length_u8() == 32,
    "Currently, this kernel only supports 256 bit vector lengths.");
  KAI_ASSUME(m == 1);
