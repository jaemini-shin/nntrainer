...
LOCAL_ARM_NEON := true
LOCAL_CFLAGS += -std=c++17 -Ofast -mcpu=cortex-a53 -Ilz4-nougat/lib -DENABLE_FP16=1 -DUSE__FP16=1 -D__ARM_NEON__=1 -march=armv9.2-a+fp16+sve2+sme+sme2 -DUSE_NEON=1 -mtune=cortex-a76 -O3 -ffast-math
LOCAL_LDFLAGS += -Llz4-nougat/lib/obj/local/$(TARGET_ARCH_ABI)/
LOCAL_CXXFLAGS += -std=c++17 -frtti
LOCAL_CFLAGS += -pthread -fexceptions -DENABLE_FP16=1 -DUSE__FP16=1 -D__ARM_NEON__=1 -march=armv9.2-a+fp16+sve2+sme+sme2 -DUSE_NEON=1 -mtune=cortex-a76 -O3 -ffast-math
LOCAL_LDFLAGS += -fexceptions -DENABLE_FP16=1 -DUSE__FP16=1 -D__ARM_NEON__=1 -march=armv9.2-a+fp16+sve2+sme+sme2 -DUSE_NEON=1 -mtune=cortex-a76 -O3 -ffast-math
LOCAL_ARM_MODE := arm
LOCAL_MODULE := causallm_core
LOCAL_LDLIBS := -llog -landroid -DENABLE_FP16=1 -DUSE__FP16=1 -D__ARM_NEON__=1 -march=armv9.2-a+fp16+sve2+sme+sme2 -DUSE_NEON=1
...
LOCAL_ARM_NEON := true
LOCAL_CFLAGS += -std=c++17 -Ofast -mcpu=cortex-a53 -DENABLE_FP16=1 -DUSE__FP16=1 -D__ARM_NEON__=1 -march=armv9.2-a+fp16+sve2+sme+sme2 -DUSE_NEON=1 -mtune=cortex-a76 -O3 -ffast-math
LOCAL_CXXFLAGS += -std=c++17 -frtti
LOCAL_CFLAGS += -pthread -fexceptions -DENABLE_FP16=1 -DUSE__FP16=1 -D__ARM_NEON__=1 -march=armv9.2-a+fp16+sve2+sme+sme2 -DUSE_NEON=1 -mtune=cortex-a76 -O3 -ffast-math
LOCAL_LDFLAGS += -fexceptions -DENABLE_FP16=1 -DUSE__FP16=1 -D__ARM_NEON__=1 -march=armv9.2-a+fp16+sve2+sme+sme2 -DUSE_NEON=1 -mtune=cortex-a76 -O3 -ffast-math
LOCAL_ARM_MODE := arm
...
LOCAL_LDFLAGS += -Llz4-nougat/lib/obj/local/$(TARGET_ARCH_ABI)/
LOCAL_CXXFLAGS += -std=c++17 -frtti
LOCAL_CFLAGS += -pthread -fexceptions -fopenmp -static-openmp -DENABLE_FP16=1 -DUSE__FP16=1 -D__ARM_NEON__=1 -march=armv9.2-a+fp16+sve2+sme+sme2 -DUSE_NEON=1 -mtune=cortex-a76 -O3 -ffast-math
LOCAL_LDFLAGS += -fexceptions -fopenmp -static-openmp -DENABLE_FP16=1 -DUSE__FP16=1 -D__ARM_NEON__=1 -march=armv9.2-a+fp16+sve2+sme+sme2 -DUSE_NEON=1 -mtune=cortex-a76 -O3 -ffast-math
LOCAL_MODULE_TAGS := optional
LOCAL_ARM_MODE := arm
LOCAL_MODULE := nntr_safetensors_info
LOCAL_LDLIBS := -llog -landroid -fopenmp -static-openmp -DENABLE_FP16=1 -DUSE__FP16=1 -D__ARM_NEON__=1 -march=armv9.2-a+fp16+sve2+sme+sme2 -DUSE_NEON=1
